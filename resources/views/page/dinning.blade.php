...
@section('content')
<section class="image-head-wrapper" style="background-image: url('assets/images/banner2.jpg');">
            ...
            <aside class="col-md-3 col-sm-4 col-xs-12">
                ...
                <div class="blog-list1">
                    ...
                    <div class="blog-list-top">
                        <div class="blog-img">
                            <a><img class="img-responsive" src="{{ asset('assets/images/Home/img1.jpg') }}" alt=""></a>
                        </div>
                        <div class="blog-text">
                    ...
                    <div class="blog-list-top">
                        <div class="blog-img">
                            <a><img class="img-responsive" src="{{ asset('assets/images/Home/img3.jpg') }}" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <p><a>Lorem ipsum dolor sit amet, consectetuer</a></p>
                            <span class="link">
                    ...
                    <div class="blog-list-top">
                        <div class="blog-img">
                            <a><img class="img-responsive" src="{{ asset('assets/images/Home/img4.jpg') }}" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <p><a>Lorem ipsum dolor sit amet, consectetuer</a></p>
                            <span class="link">
                    ...
                    <div class="blog-list-top">
                        <div class="blog-img">
                            <a><img class="img-responsive" src="{{ asset('assets/images/Home/img5.jpg') }}" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <p><a>Lorem ipsum dolor sit amet, consectetuer</a></p>
                            <span class="link">
