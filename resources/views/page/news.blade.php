        ...
        <div class="row">
            <div class="col-md-6 col-sm-12 col-xs-12 remove-padd-right">
                <div class="side-A">
                    <div class="product-thumb">
                        <div class="image">
                            <a href="#single-blog.html"><img alt="image" class="img-responsive" src="{{ asset('assets/images/category1.png') }}"></a>
                        </div>
                    </div>
                </div>
                <div class="side-B">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12 remove-padd-left">
                <div class="side-A">
                    <div class="product-thumb">
                        <div class="image">
                            <a href="#single-blog.html"><img src="{{ asset('assets/images/category2.png') }}" class="img-responsive" alt="image"></a>
                        </div>
                    </div>
                </div>
                <div class="side-B">
                ...
                <div class="side-B">
                    <div class="product-thumb">
                        <div class="image txt-rgt">
                            <a class="arrow-left" href="#single-blog.html"><img alt="imaga" class="img-responsive" src="{{ asset('assets/images/category3.png') }}"></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-sm-12 col-xs-12 remove-padd-left">
                ...
                <div class="side-B">
                    <div class="product-thumb txt-rgt">
                        <div class="image">
                            <a class="arrow-left" href="#single-blog.html"><img alt="imaga" class="img-responsive" src="{{ asset('assets/images/category4.png') }}"></a>
                        </div>
                    </div>
                </div>
            </div>
